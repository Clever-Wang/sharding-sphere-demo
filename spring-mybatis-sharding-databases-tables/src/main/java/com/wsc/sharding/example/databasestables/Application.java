package com.wsc.sharding.example.databasestables;
...
public class Application {
	...
	private static final String CONFIG_FILE = "spring/application-sharding-databases-tables.xml";
	...
	public static void main(String[] args) throws InterruptedException {
		...
		try (ConfigurableApplicationContext applicationContext = new ClassPathXmlApplicationContext(CONFIG_FILE)) {
			...
			logger.error(" spring-mybatis-sharding-databases-tables start fail ",e);
			System.exit(0);
		}
